...
//                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frama_layout, fragment).commit();
                        ...
                        fragmentTransaction.replace(R.id.frama_layout, new Question2()).commit();
                    }
...
//                   "please check your internet connection", false);
            ...
            webView.loadUrl("http://brilliancetechnologies.com/andriod_apps/ldc_prev_app_8793479_view/model_subject_100_test.php?id=22");
            return v;
        }
