...
//                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frama_layout, fragment).commit();
                        ...
                        fragmentTransaction.replace(R.id.frama_layout, new Model1()).commit();
                    }
...
//                   "please check your internet connection", false);
            ...
            webView.loadUrl("http://brilliancetechnologies.com/andriod_apps/ldc_prev_app_8793479_view/model_exam_main_test.php?id=65");
