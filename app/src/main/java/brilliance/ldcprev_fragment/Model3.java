...
public class Model3 extends Fragment {
    Button RETRY;
...
//                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frama_layout, fragment).commit();
                        ...
                        fragmentTransaction.replace(R.id.frama_layout, new Model3()).commit();
                    }
...
//                   "please check your internet connection", false);
            ...
            View v = inflater.inflate(R.layout.web1, null);
            WebView webView = (WebView) v.findViewById(R.id.web_id1);
            progressBar = (ProgressBar)v.findViewById(R.id.progressBar1);
            webView.getSettings().setBuiltInZoomControls(true);
            webView.getSettings().setJavaScriptEnabled(true);
            webView.getSettings().setSaveFormData(true);
            webView.setWebViewClient(new MyWebViewClient());
            webView.loadUrl("http://brilliancetechnologies.com/andriod_apps/ldc_prev_app_8793479_view/model_exam_main_test.php?id=67");
            return v;
        }
